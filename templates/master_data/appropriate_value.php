<?php
// header.php จะถูกเรียกจากตำแหน่งที่ถูกต้อง
//include_once '../header.php'; 

// ใช้วิธีอ้างอิงจาก Root ของโปรเจกต์
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ค่ามาตรฐาน / ค่าที่เหมาะสม</h1>
</div>
<!-- แสดง Alert Container สำหรับแจ้งเตือนต่างๆ -->
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="appropriate_value_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="appropriate_value_id" name="appropriate_value_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-4">
                    <label for="name_full" class="form-label">ชื่อเต็ม</label>
                    <input type="text" class="form-control" id="name_full" name="name_full" required disabled>
                </div>
                <div class="col-md-5">
                    <label for="name_abbr" class="form-label">ชื่อย่อ</label>
                    <input type="text" class="form-control" id="name_abbr" name="name_abbr" required disabled>
                </div>
                <div class="col-md-4">
                    <label for="value_min" class="form-label">ค่าต่ำสุด</label>
                    <input type="number" step="0.01" class="form-control" id="value_min" name="value_min" required disabled>
                </div>
                <div class="col-md-4">
                    <label for="value_max" class="form-label">ค่าสูงสุด</label>
                    <input type="number" step="0.01" class="form-control" id="value_max" name="value_max" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส ชื่อเต็ม ชื่อย่อ หรือตัวเลข เพื่อค้นหา...">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody id="data-table-body">
                    <tr>
                        <td colspan="7" class="text-center">ยังไม่มีการค้นหาข้อมูล...</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<?php
// เรียกใช้งาน footer ซึ่งจะมี Modal และ JS Library ทั้งหมดอยู่
//include_once '../../templates/footer.php'; 
include_once $_SERVER['DOCUMENT_ROOT'] . '/envi_sys/templates/footer.php';
?>

<script src="../../assets/js/appropriate_value.js"></script>
