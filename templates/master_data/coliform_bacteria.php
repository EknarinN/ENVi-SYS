...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : การตรวจพบโคลิฟอร์ม</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="coliform_bacteria_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="coliform_bacteria_id" name="coliform_bacteria_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="found" class="form-label">การตรวจพบ</label>
                    <input type="text" class="form-control" id="found" name="found" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ การตรวจพบ เพื่อค้นหา...">
...
?>
<script src="../../assets/js/coliform_bacteria.js"></script>
</body>
