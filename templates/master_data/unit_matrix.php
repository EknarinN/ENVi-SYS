...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : หน่วยนับน้ำหนัก</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="unit_matrix_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="unit_matrix_id" name="unit_matrix_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-4">
                    <label for="name_eng" class="form-label">ชื่อเต็ม (Eng)</label>
                    <input type="text" class="form-control" id="name_eng" name="name_eng" required disabled>
                </div>
                <div class="col-md-5">
                    <label for="name_abbreviation_eng" class="form-label">ชื่อย่อ (Eng)</label>
                    <input type="text" class="form-control" id="name_abbreviation_eng" name="name_abbreviation_eng" required disabled>
                </div>
                <div class="col-md-3">
                    <label for="name_th" class="form-label">ชื่อเต็ม (ไทย)</label>
                    <input type="text" class="form-control" id="name_th" name="name_th" required disabled>
                </div>
                <div class="col-md-4">
                    <label for="name_abbreviation_th" class="form-label">ชื่อย่อ (ไทย)</label>
                    <input type="text" class="form-control" id="name_abbreviation_th" name="name_abbreviation_th" required disabled>
                </div>
...
?>
<script src="../../assets/js/unit_matrix.js"></script>
</body>
