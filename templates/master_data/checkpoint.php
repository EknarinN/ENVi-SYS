...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : จุดตรวจ / สถานที่ติดตั้ง</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="checkpoint_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="checkpoint_id" name="checkpoint_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="name_location" class="form-label">ชื่อจุดตรวจ / สถานที่</label>
                    <input type="text" class="form-control" id="name_location" name="name_location" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ ชื่อจุดตรวจ เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ชื่อจุดตรวจ / สถานที่</th>
