...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : สถานะของสสาร</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="state_of_matter_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="state_of_matter_id" name="state_of_matter_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-4">
                    <label for="matter_en" class="form-label">สถานะสสาร (Eng)</label>
                    <input type="text" class="form-control" id="matter_en" name="matter_en" required disabled>
                </div>
                <div class="col-md-3">
                    <label for="matter_th" class="form-label">สถานะสสาร (ไทย)</label>
                    <input type="text" class="form-control" id="matter_th" name="matter_th" required disabled>
                </div>
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">สถานะสสาร (Eng)</th>
                        <th scope="col">สถานะสสาร (ไทย)</th>
...
?>
<script src="../../assets/js/state_of_matter.js"></script>
</body>
</html>