...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ชิ้นส่วนถังดับเพลิง</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="fire_extinguisher_parts_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="fire_extinguisher_parts_id" name="fire_extinguisher_parts_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="name_parts" class="form-label">ชื่อชิ้นส่วน</label>
                    <input type="text" class="form-control" id="name_parts" name="name_parts" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ ชื่อชิ้นส่วน เพื่อค้นหา...">
...
?>
<script src="../../assets/js/fire_extinguisher_parts.js"></script>
</body>
</html>