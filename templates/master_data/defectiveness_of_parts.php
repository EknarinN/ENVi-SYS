...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ความชำรุดของชิ้นส่วน</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="defectiveness_of_parts_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="defectiveness_of_parts_id" name="defectiveness_of_parts_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="name_defectiveness" class="form-label">ความชำรุดของชิ้นส่วน</label>
                    <input type="text" class="form-control" id="name_defectiveness" name="name_defectiveness" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ ชื่อความชำรุด เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ความชำรุดของชิ้นส่วน</th>
...
?>
<script src="../../assets/js/defectiveness_of_parts.js"></script>
</body>
</html>