...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : หน่วยงานย่อย</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-2">
                    <label for="department_sub_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="department_sub_id" name="department_sub_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-5">
                    <label for="name_departments" class="form-label">ชื่อหน่วยงานย่อย</label>
                    <input type="text" class="form-control" id="name_departments" name="name_departments" required disabled>
                </div>
                <div class="col-md-3">
                    <label for="departments_group_id" class="form-label">กลุ่มงานหลัก</label>
                    <select class="form-select" id="departments_group_id" name="departments_group_id" required disabled></select>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="ค้นหาชื่อหน่วยงาน หรือ กลุ่มงาน...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ชื่อหน่วยงานย่อย</th>
                        <th scope="col">กลุ่มงานหลัก</th>
                ...
                <tbody id="data-table-body">
                    <tr>
                        <td colspan="5" class="text-center">ยังไม่มีการค้นหาข้อมูล...</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
?>
<script src="../../assets/js/departments_sub.js"></script>
</body>
</html>