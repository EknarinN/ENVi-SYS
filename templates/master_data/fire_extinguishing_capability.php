...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ความสามารถในการดับเพลิง</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="capability_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="capability_id" name="capability_id" placeholder="กรอกรหัส (0 หรือ 1)" disabled>
                </div>
                <div class="col-md-6">
                    <label for="name_capability" class="form-label">ความสามารถในการดับเพลิง</label>
                    <input type="text" class="form-control" id="name_capability" name="name_capability" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ ชื่อความสามารถ เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ความสามารถในการดับเพลิง</th>
                        <th scope="col">สถานะ</th>
                        <th scope="col" style="width: 10%;">จัดการ</th>
                    </tr>
                </thead>
                <tbody id="data-table-body">
                    <tr><td colspan="4" class="text-center">ยังไม่มีการค้นหาข้อมูล...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
...
?>
<script src="../../assets/js/fire_extinguishing_capability.js"></script>
</body>
</html>