...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : กลุ่มงานหลัก</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="department_group_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="department_group_id" name="department_group_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="name_group" class="form-label">ชื่อกลุ่มงาน</label>
                    <input type="text" class="form-control" id="name_group" name="name_group" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์ชื่อกลุ่มงาน เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ชื่อกลุ่มงานหลัก</th>
...
?>
<script src="../../assets/js/departments_group.js"></script>
</body>
</html>