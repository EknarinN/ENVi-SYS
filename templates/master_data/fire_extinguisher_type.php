...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ประเภทของถังดับเพลิง</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="fire_extinguisher_type_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="fire_extinguisher_type_id" name="fire_extinguisher_type_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-6">
                    <label for="name_type" class="form-label">ประเภทของถังดับเพลิง</label>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ ประเภทของถังดับเพลิง เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">ประเภทของถังดับเพลิง</th>
...
?>
<script src="../../assets/js/fire_extinguisher_type.js"></script>
</body>
</html>