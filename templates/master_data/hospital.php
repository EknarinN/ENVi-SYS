...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : หน่วยบริการ / รพ.สต.</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="hospital_id" class="form-label">รหัส (HPxx)</label>
                    <input type="text" class="form-control" id="hospital_id" name="hospital_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-3">
                    <label for="hosp_id" class="form-label">รหัส (5 หลัก)</label>
                    <input type="text" class="form-control" id="hosp_id" name="hosp_id" required disabled>
                </div>
                <div class="col-md-6">
                    <label for="hosp_name" class="form-label">ชื่อหน่วยบริการ</label>
                    <input type="text" class="form-control" id="hosp_name" name="hosp_name" required disabled>
                </div>
                <div class="col-md-3">
                    <label for="sub_district_id" class="form-label">รหัสตำบล</label>
                    <input type="text" class="form-control" id="sub_district_id" name="sub_district_id" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="ค้นหา รหัส หรือ ชื่อหน่วยบริการ...">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        <th scope="col">รหัส (HPxx)</th>
                        <th scope="col">รหัส (5 หลัก)</th>
