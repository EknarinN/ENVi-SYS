...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : ประเภทของเพลิงไหม้</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-2">
                    <label for="fire_type_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="fire_type_id" name="fire_type_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-4">
                    <label for="name_fire_type" class="form-label">ประเภทของเพลิงไหม้</label>
                    <input type="text" class="form-control" id="name_fire_type" name="name_fire_type" required disabled>
                </div>
                <div class="col-md-6">
                    <label for="description" class="form-label">คำอธิบาย</label>
                    <textarea class="form-control" id="description" name="description" placeholder="สามารถย่อ-ขยายได้ สำหรับอ่านข้อความหลายบรรทัด" rows="1" required disabled></textarea>
                </div>
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col" style="width: 15%;">ประเภทของเพลิงไหม้</th>
...
?>
<script src="../../assets/js/fire_type.js"></script>
</body>
</html>