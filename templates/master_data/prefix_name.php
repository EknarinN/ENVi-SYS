...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">ตั้งค่า : คำนำหน้าชื่อ</h1>
</div>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body bg-success-subtle">
        <form id="data-form">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <label for="prefix_name_id" class="form-label">รหัส</label>
                    <input type="text" class="form-control" id="prefix_name_id" name="prefix_name_id" placeholder="ระบบจะสร้างให้อัตโนมัติ" readonly>
                </div>
                <div class="col-md-4">
                    <label for="full_word" class="form-label">คำนำหน้าชื่อ (เต็ม)</label>
                    <input type="text" class="form-control" id="full_word" name="full_word" required disabled>
                </div>
                <div class="col-md-3">
                    <label for="abbreviation_word" class="form-label">คำนำหน้าชื่อ (ย่อ)</label>
                    <input type="text" class="form-control" id="abbreviation_word" name="abbreviation_word" required disabled>
                </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="input-group">
                    <input type="text" id="search-box" class="form-control" placeholder="พิมพ์รหัส หรือ คำนำหน้าชื่อ เพื่อค้นหา...">
            ...
            <table class="table table-bordered table-striped table-hover">
                <thead class="table-light text-center">
                    <tr>
                        ...
                        <th scope="col">คำนำหน้าชื่อ (เต็ม)</th>
                        <th scope="col">คำนำหน้าชื่อ (ย่อ)</th>
...
?>
<script src="../../assets/js/prefix_name.js"></script>
</body>
