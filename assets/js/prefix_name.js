$(document).ready(function() {
    ...
    function setFormState(state) {
        ...
        $('input:not(#prefix_name_id)', dataForm).prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/prefix_name_handler.php',
            type: 'GET',
                    ...
                    response.data.forEach(item => {
                        ...
                        const row = `
                            <tr data-id="${item.id}">
                                ...
                                <td>${item.full_word}</td>
                                <td>${item.abbreviation_word}</td>
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#edit_id').val(data.id);
                $('#prefix_name_id').val(data.id);
                $('#full_word').val(data.full_word);
                $('#abbreviation_word').val(data.abbreviation_word);
