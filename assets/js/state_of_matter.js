$(document).ready(function() {
    ...
    const stateIdField = $('#state_of_matter_id');
    ...
    function setFormState(state) {
        ...
        $('input', dataForm).not('#edit_id').not('#state_of_matter_id').prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/state_of_matter_handler.php',
            type: 'GET',
                    ...
                    response.data.forEach(item => {
                        ...
                        const row = `
                            <tr data-id="${item.id}">
                                ...
                                <td>${item.matter_en}</td>
                                <td>${item.matter_th}</td>
    ...
    addNewButton.on('click', function() {
        ...
        $('#matter_en').focus(); // เปลี่ยนให้ focus ที่ช่องสถานะ (Eng)
    });
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                stateIdField.val(data.id);
                $('#matter_en').val(data.matter_en);
                $('#matter_th').val(data.matter_th);
