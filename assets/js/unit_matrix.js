$(document).ready(function () {
  ...
  function fetchData(query = "") {
    ...
    $.ajax({
      url: "../../core/unit_matrix_handler.php",
      type: "GET",
          ...
          response.data.forEach((item) => {
            ...
            const row = `
                            <tr data-id="${item.id}">
                                ...
                                <td>${item.name_eng}</td>
                                <td>${item.name_abbreviation_eng}</td>
                                <td>${item.name_th}</td>
                                <td>${item.name_abbreviation_th}</td>
  ...
  addNewButton.on("click", function () {
    ...
    $("#name_eng").focus(); // เปลี่ยนให้ focus ที่ช่องถัดไปแทน
  });
  ...
  tableBody.on("click", ".edit-btn", function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $("#unit_matrix_id").val(data.id);
        $("#name_eng").val(data.name_eng);
        $("#name_abbreviation_eng").val(data.name_abbreviation_eng);
        $("#name_th").val(data.name_th);
        $("#name_abbreviation_th").val(data.name_abbreviation_th);
