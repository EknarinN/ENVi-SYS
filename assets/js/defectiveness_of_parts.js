$(document).ready(function() {
    ...
    const defectivenessIdField = $('#defectiveness_of_parts_id');
    ...
    function setFormState(state) {
        ...
        $('input:not(#defectiveness_of_parts_id)', dataForm).prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/defectiveness_of_parts_handler.php',
            type: 'GET',
    ...
    addNewButton.on('click', function() {
        ...
        $('#name_defectiveness').focus(); // เปลี่ยนให้ focus ที่ช่องชื่อความชำรุด
    });
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                defectivenessIdField.val(data.id);
                $('#name_defectiveness').val(data.name_defectiveness);
