$(document).ready(function() {
    ...
    function setFormState(state) {
        ...
        $('input:not(#fire_extinguisher_type_id)', dataForm).prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/fire_extinguisher_type_handler.php',
            type: 'GET',
    ...
    addNewButton.on('click', function() {
        ...
        $('#name_type').focus(); // เปลี่ยนให้ focus ที่ช่องชื่อประเภท
    });
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#fire_extinguisher_type_id').val(data.id);
