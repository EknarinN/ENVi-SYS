$(document).ready(function() {
    ...
    function setFormState(state) {
        ...
        $('input', dataForm).not('#edit_id').not('#emer_light_type_id').prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/emer_lights_type_handler.php',
            type: 'GET',
    ...
    addNewButton.on('click', function() {
        ...
        $('#emer_light_type_id').prop('disabled', false).focus();
    });

    editButton.on('click', function() { 
        setFormState('enabled'); 
        $('#emer_light_type_id').prop('disabled', true);
    });
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#emer_light_type_id').val(data.id);
