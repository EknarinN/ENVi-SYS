$(document).ready(function() {
    ...
    function setFormState(state) {
        ...
        $('input:not(#coliform_bacteria_id)', dataForm).prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/coliform_bacteria_handler.php',
            type: 'GET',
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#edit_id').val(data.id);
                $('#coliform_bacteria_id').val(data.id);
                $('#found').val(data.found);
