$(document).ready(function() {
    ...
    const departmentGroupIdField = $('#department_group_id');
    ...
    function setFormState(state) {
        ...
        $('input:not(#department_group_id)', dataForm).prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/departments_group_handler.php',
            type: 'GET',
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                departmentGroupIdField.val(data.id);
