$(document).ready(function() {
    ...
    const fireTypeIdField = $('#fire_type_id');
    ...
    function setFormState(state) {
        ...
        dataForm.find('input, textarea').not('#edit_id').not('#fire_type_id').prop('disabled', is_disabled);
    ...
    function fetchData(query = '') {
        ...
        $.ajax({
            url: '../../core/fire_type_handler.php',
            type: 'GET',
    ...
    tableBody.on('click', '.edit-btn', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                fireTypeIdField.val(data.id);
                $('#name_fire_type').val(data.name_fire_type);
